...
# Action Space (0 to 5 for each material)
...
for _ in range(MAT_COUNT):
    STATE_MINS.append(0)
    STATE_MAXS.append(ACTION_MAX * 7)  # Max action * max lead time
...
# # Network Parameters
# HIDDEN_LAYER_SIZES = [256, 256]  # Sizes of hidden layers in neural networks
